...
public class EntryRegister extends AppCompatActivity
    ...
    Dialog about;
    String[] purpose_items = new String[]{"Meeting", "Visit", "Delivery", "Enquiry", "Admission", "Fee Deposit","Others"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        about= new Dialog(EntryRegister.this);
...
//        frag_photo.setImageResource(R.drawable.address);
        ...
        tick = findViewById(R.id.checkboxEntry);
                                    ...
                                    if (isValidNumber(mobile.getText().toString())){
                                        if (!TextUtils.isEmpty(purpose.getText().toString())){
                                            if (!TextUtils.isEmpty(address.getText().toString())){
                                                ...
                                                Toast.makeText(EntryRegister.this, "Address is Empty", Toast.LENGTH_SHORT).show();
                                            }

                                        }else{
                                            Toast.makeText(EntryRegister.this, "Purpose is empty", Toast.LENGTH_SHORT).show();
                                        }
                                    }else{
                                        Toast.makeText(EntryRegister.this, "Mobile Number is not in roght format", Toast.LENGTH_SHORT).show();
                                    }
                                }else{
                                    Toast.makeText(EntryRegister.this, "Mobile Number isEmpty", Toast.LENGTH_SHORT).show();
                                }
                            }else{
                                Toast.makeText(EntryRegister.this, "Enter Name", Toast.LENGTH_SHORT).show();
                            }
                        }else{
                            Toast.makeText(EntryRegister.this, "Image Not Selected Yet", Toast.LENGTH_SHORT).show();
                        }
                    }else {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.entryRecord) {
            ...
            final EditText password = new EditText(EntryRegister.this);
            ...
            builder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    if (!TextUtils.isEmpty(password.getText())) {
                        ...
                        Toast.makeText(EntryRegister.this, "New Password is Empty", Toast.LENGTH_SHORT).show();
                    }
                }
            });
...
//                    isRecording=false;
    ...
    public void recordAudio(){
        ...
        Toast.makeText(EntryRegister.this, "Recording started",
...
//                uploading.dismiss();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(EntryRegister.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.hide();
                        Toast.makeText(EntryRegister.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
    ...
    private void logout() {
        ...
        editor.clear();
        editor.apply();
        startActivity(new Intent(EntryRegister.this, MainActivity.class));
    }
...
//            uploadVideo();
    ...
    public void getProfile(){
        ...
        requestQueue = Volley.newRequestQueue(EntryRegister.this);
